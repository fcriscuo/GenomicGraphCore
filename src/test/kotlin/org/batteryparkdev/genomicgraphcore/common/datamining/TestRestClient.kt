...
fun main() {
    val filename = "/tmp/test_uniprot_id.tsv"
    ...
    "https://rest.uniprot.org/uniprotkb/stream?fields=accession%2Creviewed%2Cid%2Corganism_name%2Cxref_geneid%2Cxref_hgnc%2Cgo_id&format=tsv&query=%28reviewed%3Atrue%29+AND+%28model_organism%3A9606%29"
