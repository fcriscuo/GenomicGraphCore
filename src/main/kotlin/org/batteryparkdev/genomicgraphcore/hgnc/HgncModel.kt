...
data class HgncModel(val hgncId: String, val geneName: String, val geneSymbol: String,
                     ...
                     val pubmedIds: String, val mgdId: String, val regId: String, val lsdb: String,
    ...
    //override fun generateLoadModelCypher(): String  = generateMergeCypher().plus(" RETURN  $nodename \n")
    ...
    override fun getPubMedId(): Int = when (pubmedIds.isEmpty()){
        true -> 0
        false -> pubmedIds.split(",")[0].toInt()
    }
